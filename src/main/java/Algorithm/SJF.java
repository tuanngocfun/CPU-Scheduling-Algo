 ...
 * @version 1.0
 */
public final class SJF extends NonPreemptiveScheduling {
    public static final String SJF_REGEX = "^(?i)(non-?preemptive)? *SJF$";
    
    public SJF(ScheduleTable table, CycleComponent component, ReadyQueue queue) {
