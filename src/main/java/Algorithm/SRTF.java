 ...
 * @version 1.0
 */
public final class SRTF extends PreemptiveScheduling {
    public static final String SRTF_REGEX = "^(?i)SRTF|(preemptive)? *SJF$";
    
    public SRTF(ScheduleTable table, CycleComponent component, ReadyQueue queue) {
