...
public class SRTFAndFIFOTest {

    private Scheduler scheduler;
    private ScheduleTable scheduleTable;
    private CPU cpu;
    private IODevice r1, r2, r3;
    ...
    public void setUp() {
        ...
        r3 = new IODevice("R3", 3, new GanttChart());
        scheduler = new Scheduler("SRTF", "FCFS");
        ...
        s1.addCycle(1, new Cycle(new CPUBurst(cpu, 6), new IOBurst(r1, 3)));
        s1.addCycle(2, new Cycle(new CPUBurst(cpu, 3), new IOBurst(r2, 4)));
        s1.addCycle(3, new Cycle(new CPUBurst(cpu, 1), null));


        SchedulingInfo s2 = new SchedulingInfo(1, 2);
        s2.addCycle(1, new Cycle(new CPUBurst(cpu, 3), new IOBurst(r2, 2)));
        s2.addCycle(2, new Cycle(new CPUBurst(cpu, 2), new IOBurst(r3, 6)));
        s2.addCycle(3, new Cycle(new CPUBurst(cpu, 3), null));

        SchedulingInfo s3 = new SchedulingInfo(2, 2);
        s3.addCycle(1, new Cycle(new CPUBurst(cpu, 2), new IOBurst(r1, 3)));
        s3.addCycle(2, new Cycle(new CPUBurst(cpu, 4), new IOBurst(r2, 2)));
        s3.addCycle(3, new Cycle(new CPUBurst(cpu, 3), null));

        SchedulingInfo s4 = new SchedulingInfo(3, 5);
        s4.addCycle(1, new Cycle(new CPUBurst(cpu, 4), new IOBurst(r3, 4)));
        s4.addCycle(2, new Cycle(new CPUBurst(cpu, 3), new IOBurst(r1, 3)));
    ...
    public void testRRandFIFOScheduling() {
        ...
        assertTrue(result.getWaitingTime() == 10.75);
        assertTrue(result.getTurnaroundTime() == 27.5);
    }
}