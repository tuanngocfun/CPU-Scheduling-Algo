...
public class GUIDataHandlerTest {
    ...
    // @Test
    // public void testHandleGUIInput() {
    //     // Setup and execute your test logic
    //     ScheduleTableModel tableModel = setupTableModel();
    //     GUIInputData inputData = new GUIInputData(tableModel, "Round Robin", "Priority");
    //     GUIDataHandler dataHandler = new GUIDataHandler();

    //     GUIProcessedData processedData = dataHandler.handleGUIInput(inputData);
    //     String output = convertToJson(processedData);

    //     // Use Approvals to verify the output
    //     Approvals.verify(output);
    // }

    // private ScheduleTableModel setupTableModel() {
    //     String[] columnNames = {"Process", "System Arrival Time", "RQ Arrival Time",
    //                             "CPU Burst 1", "IO Burst 1", "CPU Burst 2", "IO Burst 2"};
    //     ScheduleTableModel tableModel = new ScheduleTableModel();
    //     tableModel.setColumnIdentifiers(columnNames);
    ...
    // private String convertToJson(GUIProcessedData processedData) {
    //     if (processedData == null) {
    //         return "Processed data is null";
    //     }
    //     StringBuilder builder = new StringBuilder();
    //     builder.append("RunResult Waiting Time: ").append(processedData.getRunResult().getWaitingTime()).append("\n");
    //     builder.append("RunResult Turnaround Time: ").append(processedData.getRunResult().getTurnaroundTime()).append("\n");
    //     for (Process process : processedData.getProcesses()) {
    //         RunningInterval runningInterval = processedData.getRunningInterval(process);
...
//     @Test
//     public void testHandleGUIInput2() {
//         // Set the columns including cycles
//         String[] columnNames = {"Process", "System Arrival Time", "RQ Arrival Time",
//                                 "CPU Burst 1", "IO Burst 1", "CPU Burst 2", "IO Burst 2"};
...
//         // Add rows - ensure non-null and correctly formatted values
//         tableModel.addRow(new Object[]{"P1", "0", "2", "5", "R1 (4)", "3", "R2 (2)"});
//         tableModel.addRow(new Object[]{"P2", "2", "4", "4", "R3 (2)", "4", ""});
...
//         // Verify that processed data is not null
//         assert processedData != null : "Processed data should not be null";

//         // Approve the actual output against the expected output
//         Approvals.verify(processedData.toString());
//     }

//     @Test
//     public void testHandleGUIInput3() {
//         // Initialize table model and define column headers
//         ScheduleTableModel tableModel = new ScheduleTableModel();
//         String[] columnNames = {"Process", "System Arrival Time", "RQ Arrival Time", "CPU Burst 1", "IO Burst 1"};
//         tableModel.setColumnIdentifiers(columnNames);
        
//         // Add rows with correct formatting
//         tableModel.addRow(new Object[]{"P1", "0", "1", "100", "R1 (50)"});
//         tableModel.addRow(new Object[]{"P2", "1", "2", "200", "R2 (100)"});

//         // Initialize GUIInputData
//         GUIInputData inputData = new GUIInputData(tableModel, "FCFS", "Simple");
...
//         // Assertions to check non-null outputs
//         assertNotNull(processedData, "Processed data should not be null");
        
//         // Verify output (consider implementing toString in GUIProcessedData for meaningful output)
//         Approvals.verify(processedData.toString());
//     }
//     @Test
//     public void testHandleGUIInput4() {
//         // Initialize the table model and set columns as they would be set in the MainFrame
//         ScheduleTableModel tableModel = new ScheduleTableModel();
//         String[] columnNames = {"Process", "System Arrival Time", "RQ Arrival Time", "CPU Burst 1", "IO Burst 1"};
//         tableModel.setColumnIdentifiers(columnNames);

//         // Add rows with correct formatting, mimic real-world scenario based on MainFrame logic
//         tableModel.addRow(new Object[]{"P1", "0", "1", "100", "R1 (50)"});
//         tableModel.addRow(new Object[]{"P2", "1", "2", "200", "R2 (100)"});
...
//         // Check additional conditions as needed, such as correct parsing of burst times
//         // (Add more detailed checks here as required)
//     }
//     @Test
// public void testHandleGUIInput5() {
//     ScheduleTableModel tableModel = new ScheduleTableModel();
//     tableModel.setColumnIdentifiers(new String[]{"Process", "System Arrival Time", "RQ Arrival Time", "CPU Burst 1", "IO Burst 1"});
//     tableModel.addRow(new Object[]{"P1", "0", "1", "100", "R1 (50)"});
//     tableModel.addRow(new Object[]{"P2", "1", "2", "200", "R2 (100)"});
